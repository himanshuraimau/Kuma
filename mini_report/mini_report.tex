...
\begin{tabular}{lll}
Dr. Sheela S    \hspace{8cm} & Dr. N R Sunitha. \hspace{8cm}        \\
...
We would like to express our sincere gratitude to \textbf{Dr. N R Sunitha.}, Professor and Head, Department of Computer Science and Engineering, SIT, Tumakuru for her encouragement and valuable suggestions.\\
...
%\centering
{\small
\begin{tabular}{|c|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{7cm}|c|}
\hline 
