...
> Complete examples showing how to use Supermemory with Vercel AI SDK for building intelligent applications
...
<CodeGroup>
  ```typescript Documentation Chat theme={null}
  import { streamText } from 'ai'
  ...
  ```typescript Upload Documentation theme={null}
...
<CodeGroup>
  ...
  ```typescript File Upload Handler theme={null}
  import { addMemory } from '@supermemory/tools'
